    ...
    public class SponsoredListingOfferController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                this.TempData[Constants.StringConstants.SuccessMessage] = "The sponsored listing offer has been successfully deleted.";
            }
            catch (Exception ex)
            {
                this.TempData[Constants.StringConstants.ErrorMessage] = $"Failed to delete the offer: {ex.Message}";
            }
