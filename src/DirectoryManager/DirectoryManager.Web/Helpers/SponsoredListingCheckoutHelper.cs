...
namespace DirectoryManager.Web.Helpers
{
    ...
    internal static class SponsoredListingCheckoutHelper
    {
        ...
        /// <summary>
        /// Maps a BTCPay webhook event (plus its flags) onto our internal PaymentStatus.
        ...
        /// <param name="overPaid">From InvoiceSettled payloads.</param>
            ...
            decimal? amountDue = null)
        {
            ...
            return eventType.Trim() switch
            {
                ...
                // Settled — distinguish exact vs. overpaid.
                var t when t.Equals("InvoiceSettled", StringComparison.OrdinalIgnoreCase)
                    => overPaid ? PaymentStatus.OverPayment : PaymentStatus.Paid,
